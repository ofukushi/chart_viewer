...
# def fetch_daily_quotes(code, id_token, years: int = 10):
#     today = dt.date.today()
...
# def fetch_weekly_margin_interest(code, id_token, years: int = 10):
#     headers = {'Authorization': f'Bearer {id_token}'}
...
# def fetch_short_selling_positions(code, id_token, calculated_date=None):
#     headers = {'Authorization': f'Bearer {id_token}'}
#     params = f"?code={code}"
#     if calculated_date:
#         params += f"&calculated_date={calculated_date}"
